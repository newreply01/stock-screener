...
async function injectBatchPart(partNum, startIndex, endIndex) {
    console.log(`🚀 Starting injection for Batch 12 Part ${partNum} (Indices ${startIndex}-${endIndex})...`);
    
    const contextPath = path.join(__dirname, 'batch_context_12.json');
...
// Part 5: symbols 400 to 500
injectBatchPart(5, 400, 500).then(() => process.exit(0));
