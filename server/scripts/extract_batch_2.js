...
async function run() {
    const symbols = ['2485', '009816', '1314', '6770', '1303', '0050', '00878', '2883', '2891', '2609', '00929', '2603', '2317', '2881', '2882', '00919', '2885', '5880', '2313', '2382'];
    const batchResults = [];
    try {
        ...
        fs.writeFileSync(__dirname + '/batch_context_2.json', JSON.stringify(batchResults, null, 2));
        console.log('✅ Batch 2 context saved');
    } catch (e) {
        console.error(e);
    } finally {
        await pool.end();
