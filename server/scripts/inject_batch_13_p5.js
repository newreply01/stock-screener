...
async function injectBatchPart(partNum, startIndex, endIndex) {
    console.log(`🚀 Starting injection for Batch 13 Part ${partNum} (Indices ${startIndex}-${endIndex})...`);
    
    const contextPath = path.join(__dirname, 'batch_context_13.json');
...
// Part 5 - Final stretch (400 to 488)
injectBatchPart(5, 400, 488).then(() => process.exit(0));
