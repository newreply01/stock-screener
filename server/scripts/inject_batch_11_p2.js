...
async function injectBatchPart(partNum, startIndex, endIndex) {
    console.log(`🚀 Starting injection for Batch 11 Part ${partNum} (Indices ${startIndex}-${endIndex})...`);
    
    const contextPath = path.join(__dirname, 'batch_context_11.json');
